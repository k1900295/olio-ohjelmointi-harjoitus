...
{
    public class Asunto1 : Omistaja // Muuttuja "nimi" nimi peritään luokasta Omistaja.
    {
        ...
        public void Vuokralainen()
        {
            ...
            Console.Write("\n\n Jos vuokralaisen maksu merkitään Asunto1:n omistajan  " +nimi +" tilille niin kirjoita kirjain K, muuten enter !  ");

            string ehto = Console.ReadLine();

            if (ehto == "K")
            {
                suorita.Maksa(); //Johtaa luokkaan Suoritus, missä on void Maksaminen.Maksa()-metodin  
